        ...
        <div class="w-box">
          <div class="nav-logo">
            <h1 @click="changePage(-1)">
              <router-link to="/">叮当网上药店</router-link>
            </h1>
          </div>
          <div class="right-box">
            <div class="nav-list">
              <el-input
                placeholder="请输入搜索关键词" v-model="searchInput">
            ...
            <div class="nav-aside" ref="aside" >
              <div class="user pr">
                ...
                <div class="nav-user-wrapper pa" v-if="login">
                  <div class="nav-user-list">
                    <ul>
                      <!--头像-->
                      <li class="nav-user-avatar nav-user-li">
                        <div>
              ...
              <div class="shop pr">
                ...
                <span class="cart-num"><i class="num" >{{totalNum}}</i></span>
              </div>
            </div>
          </div>
        </div>
  ...
  export default{
    data () {
      return {
        ...
        timeout: null,
        token: '',
        userInfo: {info: {file: ""}, name: "test"}, // 用户信息
        totalNum: 0, // 购物车中商品的数量
      }
    },
    created() {
      this.getUserId()
...
<style lang="scss" rel="stylesheet/scss" scoped>
  ...
  .header-box {
    ...
    background-image: linear-gradient(#F86C62, #F86C62);
    width: 100%;
  }
  header {
    height: 60px;
    ...
    .shop {
      ...
      > a {
        ...
        &:before {
          ...
          @include wh(30px, 100%);
          content: " ";
          background: url(/static/images/account-icon.png) 0 -22px;
          background-size: 240px 107px;
